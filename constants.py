...
D_E_SLIDER = DRAG_KEY+EFFORT
C_E_SLIDER = CLICK_KEY+EFFORT

W_F_SLIDER = WRITING_KEY+FRUST
P_F_SLIDER = PHRASE_KEY+FRUST
D_F_SLIDER = DRAG_KEY+FRUST
C_F_SLIDER = CLICK_KEY+FRUST
